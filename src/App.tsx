...
const readingShelfBooks: ReadingShelfBook[] = [
  ...
  },
  {
    ...
    spineTextureTrimX: 0.004,
    spineTextureTrimY: 0.004,
    coverEdgeColor: '#0b3d8a',
    spineEdgeColor: '#0b3d8a',
    coverDepthGap: 0.002,
    detailCoverRotationY: -0.25,
    pageSpineInsetRatio: 0.006,
    pageForeInsetRatio: 0.024,
  ...
  },
  {
    title: '太白金星有点烦',
    label: 'FICTION',
    note: '把西游路上的神仙与打工人困境放在一起，写出荒诞又熟悉的职场压力。',
    color: '#f6f3ec',
    accent: '#a56a13',
    coverTexture: '/assets/books/taibai-cover.png',
    backTexture: '/assets/books/taibai-back.png',
    spineTexture: '/assets/books/taibai-spine.png',
    spineTextureTrimX: 0.004,
    spineTextureTrimY: 0.004,
    coverEdgeColor: '#f0ede6',
    spineEdgeColor: '#f0ede6',
    coverDepthGap: 0.002,
    detailCoverRotationY: -0.25,
    pageSpineInsetRatio: 0.006,
    pageForeInsetRatio: 0.024,
    foreEdgeStripScale: 0.68,
    dimensionsMm: { coverWidth: 148, coverHeight: 210, spineDepth: 17 },
  },
  {
    title: '我与地坛',
    label: 'ESSAY',
    note: '在地坛的四季和人群里，重新辨认苦难、母亲与活着本身。',
    color: '#f0ede4',
    accent: '#8a6c49',
    coverTexture: '/assets/books/temple-cover.png',
    backTexture: '/assets/books/temple-back.png',
    spineTexture: '/assets/books/temple-spine.png',
    spineTextureTrimX: 0.004,
    spineTextureTrimY: 0.004,
    coverEdgeColor: '#e8e2d8',
    spineEdgeColor: '#e7e0d5',
    coverDepthGap: 0.002,
    detailCoverRotationY: -0.25,
    pageSpineInsetRatio: 0.006,
    pageForeInsetRatio: 0.024,
  ...
  },
  {
    title: '老人与海',
    label: 'CLASSIC',
    note: '在一场人与海的拉扯里，看见尊严、勇气和不可被击败的内心。',
    color: '#0b3946',
    accent: '#0d6174',
    coverTexture: '/assets/books/old-man-sea-cover.png',
    backTexture: '/assets/books/old-man-sea-back.png',
    spineTexture: '/assets/books/old-man-sea-spine.png',
    spineTextureTrimX: 0.004,
    spineTextureTrimY: 0.004,
    coverEdgeColor: '#062531',
    spineEdgeColor: '#062531',
    coverDepthGap: 0.002,
    detailCoverRotationY: -0.25,
    pageSpineInsetRatio: 0.006,
    pageForeInsetRatio: 0.024,
    foreEdgeStripScale: 0.7,
    dimensionsMm: { coverWidth: 152, coverHeight: 203, spineDepth: 16 },
  },
  {
    title: '故事新编',
    label: 'FICTION',
    note: '把古老神话和历史重新写一遍，在冷峻与讽刺里照见现实。',
    color: '#092d67',
    accent: '#0f4d96',
    coverTexture: '/assets/books/old-tales-cover.png',
    backTexture: '/assets/books/old-tales-back.png',
    spineTexture: '/assets/books/old-tales-spine.png',
    spineTextureTrimX: 0.004,
    spineTextureTrimY: 0.004,
    coverEdgeColor: '#082856',
    spineEdgeColor: '#082856',
    coverDepthGap: 0.002,
    detailCoverRotationY: -0.25,
    pageSpineInsetRatio: 0.006,
    pageForeInsetRatio: 0.024,
  ...
  return createPortal(
    <div
      ...
      style={{
        ...
        zIndex: 9999,
        overflow: 'hidden',
        backgroundColor: backdropVisible ? (book.detailBackdropColor ?? book.accent) : 'rgba(0,0,0,0)',
